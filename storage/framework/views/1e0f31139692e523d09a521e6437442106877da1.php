        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(route('test.store_edit')); ?>">
                    ...
                    <div class="form-group row">
                        <label for="rate" class="col-sm-3 col-form-label"><?php echo e(__('sentence.Rate')); ?><font color="red">*
                            </font></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rate" name="rate" value="<?php echo e($test->rate); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/doctor1/resources/views/test/edit.blade.php ENDPATH**/ ?>