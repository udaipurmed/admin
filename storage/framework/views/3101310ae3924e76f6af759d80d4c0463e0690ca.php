                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <?php if(isset($doctor->Doctor->registration)): ?>
                                <p><b><?php echo e(__('sentence.Registration')); ?> :</b> <?php echo e($doctor->Doctor->registration); ?></p>
                            <?php endif; ?>
                            
                            <?php if(isset($doctor->Doctor->qualification)): ?>
                                <p><b><?php echo e(__('sentence.Qualification')); ?> :</b> <?php echo e($doctor->Doctor->qualification); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/doctor1/resources/views/doctor/view.blade.php ENDPATH**/ ?>