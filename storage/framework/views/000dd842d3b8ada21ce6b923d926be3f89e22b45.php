   ...
   <div class="col-md-8">
      <div class="card shadow mb-4">
         ...
         <div class="card-body">
            ...
            <?php endif; ?>
            <form method="post" action="<?php echo e(route('drug.store_edit')); ?>" enctype="multipart/form-data">
               ...
               <div class="uploadbox" style="width:50%">
                                    <label class="upload_image">
                                        <img src="<?php echo e(empty($drug->image) ? url('public/imgs/no-image.png') : url('public/imgs/' . $drug->image)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/drug/edit.blade.php ENDPATH**/ ?>