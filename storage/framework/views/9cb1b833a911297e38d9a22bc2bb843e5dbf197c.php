                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea rows="2" class="form-control" id="address" name="address"
                                    placeholder="<?php echo e(__('sentence.Address')); ?>"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-9">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/doctor1/resources/views/nursebooking/create.blade.php ENDPATH**/ ?>