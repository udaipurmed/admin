      ...
      <tr>
        <td colspan="2" style="padding:15px;">
          <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;">
            <span style="display:block;font-size:13px;font-weight:normal;">Nurse Home Visit</span> Rs. <?php echo e($payment); ?>
...
</html><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/email/nursebooking.blade.php ENDPATH**/ ?>