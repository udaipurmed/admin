                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="lab_test_ids" multiple>
                                                ...
                                                <?php if(in_array($test->id, $selected_test)): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/package/edit.blade.php ENDPATH**/ ?>