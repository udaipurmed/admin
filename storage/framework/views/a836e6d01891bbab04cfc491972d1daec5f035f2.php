         ...
         <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>  
                  <?php if($appointment->in_clinic == 0): ?>
                 <a class="btn btn-danger btn-circle btn-sm"> <i class="fas fa-times"></i> </a>
                  <?php else: ?>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <p>Please enter date and time, if you want to update appointment schedule</p>

            <form id="rdv-form-update" action="<?php echo e(route('appointment.store_edit')); ?>" method="POST" >
               <input type="hidden" name="rdv_id" id="rdv_id">

               <input type="time" step="3600" name="update_time" class="form-control">
         ...
         <a class="btn btn-primary text-white" onclick="event.preventDefault(); document.getElementById('rdv-form-update').submit();">Update Appointment</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/appointment/all.blade.php ENDPATH**/ ?>