    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
          ...
          <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">Transaction ID</span> <?php echo e($appoint_id); ?></p>
          <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">Order amount</span> Rs. <?php echo e($paid); ?></p>
        </td>
      </tr>
      <tr>
        <td style="height:35px;"></td>
      ...
      <tr>
        <td colspan="2" style="padding:15px;">
          <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;">
            <span style="display:block;font-size:13px;font-weight:normal;">Appointment Booking</span> Rs. <?php echo e($paid); ?>
...
</html><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/email/appointment.blade.php ENDPATH**/ ?>