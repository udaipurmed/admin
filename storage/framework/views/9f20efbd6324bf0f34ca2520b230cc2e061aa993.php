                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <center><img
                                    src="<?php echo e(empty($patient->Patient->image) ? asset('public/img/patient-icon.png') : url('public/imgs/' . $patient->Patient->image)); ?>"
                                    class="img-profile img-fluid"></center>
                            <h4 class="text-center"><b><?php echo e($patient->name); ?></b></h4>
                            <hr>
                            <?php if(!($patient->Patient->age)): ?>
                                ...
                                <?php endif; ?>
                            <?php else: ?> if($patient->Patient->age)
                                <?php if(isset($patient->Patient->age)): ?>
                                    <p><b><?php echo e(__('sentence.Age')); ?> :</b> <?php echo e($patient->Patient->age); ?> Years</p>
                                <?php endif; ?>
                            <?php endif; ?>

                            <?php if(isset($patient->Patient->gender)): ?>
                                <p><b><?php echo e(__('sentence.Gender')); ?> :</b> <?php echo e(__('sentence.' . $patient->Patient->gender)); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/patient/view.blade.php ENDPATH**/ ?>