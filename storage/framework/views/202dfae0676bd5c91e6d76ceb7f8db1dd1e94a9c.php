                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo e($doctor->fee); ?>" type="text" class="form-control" id="fee" name="fee"
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo e($doctor->video_call); ?>" style="    width: 27px;" type="checkbox" class="form-control" id="video_call" name="video_call"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/doctor/edit.blade.php ENDPATH**/ ?>