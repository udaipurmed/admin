      ...
      <div class="card shadow mb-4">
         <div class="card-body">
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <p>Prescription Uploaded {{ __('sentence.On') }} {{ $prescription->created_at->format('d-m-Y') }}</p>
               </div>
            </div>
            ...
            <div class="row justify-content-center">
               <div class="col text-center" >
                  <img style="width: 50rem;" src="{{ empty($prescription->image) ? asset('public/img/patient-icon.png') : url('public/imgs/' . $prescription->image) }}" class="prescription_image">
            </div>
            </div>
            <!-- ROW : Drugs List -->
            <!-- <div class="row justify-content-center">
